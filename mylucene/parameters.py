...
# General parameters #
######################
data_folder = 'mylucene/lucenedata'
...
docs_path = data_folder + '/msmarco_corpus.pkl' # Path to load the articles and links.
docs_path_term = data_folder + '/msmarco_corpus.pkl' # Path to load the articles and links.
...
index_name = 'index_full'# 'index_debug' # index name for the search engine. Used when engine is 'lucene'.
