...
def main():
    ...
    parser.add_argument('--model_name', type=str, default='gpt2',#'openai-gpt',
    ...
    special_tokens_ids = list(tokenizer.convert_tokens_to_ids(token) for token in special_tokens)
    model = GPT2LMHeadModel.from_pretrained(args.model_name, num_special_tokens=len(special_tokens))
    model.to(device)
