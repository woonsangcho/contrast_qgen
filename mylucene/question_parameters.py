...
# General parameters #
######################
data_folder = 'mylucene/lucenequestiondata'
...
dataset_path = data_folder + '/msa_dataset.hdf5' # path to load the hdf5 dataset containing queries and ground-truth documents.
docs_path = data_folder + '/question_corpus.pkl' # Path to load the articles and links.
docs_path_term = data_folder + '/question_corpus.pkl' # Path to load the articles and links.
...
index_name = 'index_full' # index name for the search engine. Used when engine is 'lucene'.
# index_name = 'index_debug' # index name for the search engine. Used when engine is 'lucene'.
...
max_candidates = 90 #8 90 #990 maximum number of candidate documents that will be returned by the search engine.
